...
<html lang="en">
    <head>
        ...
        <title>Diagram Bar -Fact Purchasing</title>
    </head>
    <body>

        <div class="container-fluid">
            <h1 class="mt-2 mb-3 text-center text-primary">Diagram Bar -Fact Purchasing</h1>
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col col-sm-9">Vendor Data</div>
